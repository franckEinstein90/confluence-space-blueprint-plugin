 ...
 * @since 1.6
 */
public class HomePageContentProvider extends AbstractBlueprintContextProvider
{
    private final LocaleManager localeManager;
    private final I18NBeanFactory i18NBeanFactory;
    private final HelloService helloService;

    public HomePageContentProvider(LocaleManager localeManager, I18NBeanFactory i18NBeanFactory, HelloService helloService)
    {
    ...
    {
        final String pageTitle = i18nBean().getText("confluence.blueprints.space.epms.name");
